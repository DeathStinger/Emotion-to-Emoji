...
classifier= ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/EEWYj9x6U/model.json",ModelLoaded);
...
function check() {
 ...
 function gotResult(error,results) {
   if (error) {
    ...
    if (results[0].label == "Somewhat Sad" ) {
      document.getElementById("update_emoji").innerHTML = "&#128532";
    }

      if (results[0].label == "Super Happy" ) {
